...
)
{
	...
	if (ty) {			/* Initialization succeded */
		...
		spi_enable(SPI_MODE_4 | SPI_MODE_DR);
...
//	if (SD_MMC_WP)				/* Write protected */
//		s |= STA_PROTECT;
//	else						/* Write enabled */
//		s &= ~STA_PROTECT;
//
	if (SD_MMC_CD)				/* Card inserted */
		s &= ~STA_NODISK;
	else						/* Socket empty */
